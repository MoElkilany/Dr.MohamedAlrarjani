        ...
        <div className="grid lg:grid-cols-12 gap-12 items-center">
          ...
          <div className={`lg:col-span-7 order-1 lg:order-2 transform transition-all duration-1000 delay-300 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
            <div className="space-y-6">
              ...
              <div className="pt-4">
                <button className="bg-[#0e8fa3] text-white px-8 py-4 rounded-2xl font-semibold hover:bg-[#0a7580] transition-all duration-300 shadow-lg shadow-[#0e8fa3]/20 hover:shadow-xl flex items-center justify-center gap-2">
