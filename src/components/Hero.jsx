        ...
        <div className="grid lg:grid-cols-12 gap-8 items-center">
          <div className={`lg:col-span-7 order-2 lg:order-1 transition-all duration-1000 transform ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
            ...
            <div className="flex flex-col sm:flex-row gap-4 mb-10">
              <a href="#booking" className="group bg-white text-gray-700 border-2 border-gray-200 px-8 py-4 rounded-2xl font-semibold hover:border-[#0e8fa3] hover:text-[#0e8fa3] transition-all duration-300 flex items-center justify-center gap-2 hover:scale-105 text-center">
